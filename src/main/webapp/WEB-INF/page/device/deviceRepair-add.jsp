...
<title>添加设备维修 - 设备维修管理 - H-ui.admin v3.1</title>
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal" id="form-deviceRepair-add">
	<!-- 部门 -->
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="damageRemarks" name="damageRemarks">
		</div>
	</div>
	<div class="row cl">
...
$(function(){
	$("#form-deviceRepair-add").validate({
		rules:{
			damageRemarks:{
				required:true,
				minlength: 1,
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				async:false,
				type: 'post',
				url: "${applicationScope.path }/deviceRepair/addAfter",
