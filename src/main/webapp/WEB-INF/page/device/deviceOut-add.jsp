...
<article class="page-container">
	<form class="form form-horizontal" id="form-deviceOut-add">
	<!-- 部门 -->
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="outRemarks" name="outRemarks">
		</div>
	</div>
	<div class="row cl">
	...
	$("#form-deviceOut-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				async:false,
				type: 'post',
				url: "${applicationScope.path }/deviceOut/addAfter",
